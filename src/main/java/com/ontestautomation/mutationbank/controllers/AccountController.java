...
public class AccountController {
    ...
    public ResponseEntity<Account> depositToAccount(@PathVariable Long id, @PathVariable double amount) {
    ...
    public ResponseEntity<Account> withdrawFromAccount(@PathVariable Long id, @PathVariable("amount") double amount) {
    ...
    public ResponseEntity<Account> addInterestToAccount(@PathVariable Long id) {
